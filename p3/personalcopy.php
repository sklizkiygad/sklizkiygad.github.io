...
<div class="container-fluid " style="background-image: url(../img/personal.jpg); background-size: cover; padding:0px 1px !important;">
     ...
     <div class="blur"> 
      ...
      <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #0a23355e;">
        ...
        <h1 style="margin-top: 100px;color:beige" class="text-center">Доступные работяги</h1>
...
while(($cat=mysqli_fetch_assoc($result)))
{
  ...
  echo '<td>'. $cat['LoginW']. '</td>' . '<td>'. $cat['PhoneNumW'].'</td>'. '<td>'.$cat['Post']. '</td>'. '<td>'. $cat['hall'].'</td>';
  echo '</tr>';
...
?>
          ...
          <h1 style="margin-top: 265px;color:beige;size: 25px;font-family: 'Comfortaa', cursive;" class="text-center">"Ну чего, ты хочешь меня обнять? Милости просим, мсье, давай. Я тебя тогда тоже обниму. Ну и чего? Обнимемся, вместе пойдем, да?"&copy; Кровавый Барон</h1>
          <br>
